...
/**
 * Created by xhe on 2017/4/28.
 * 事故判定需要的相机
 */

public class AccidentCameraActivity extends BaseActivity implements Camera.PictureCallback, View.OnClickListener {
    ...
    public int getLayoutID() {
        ...
        return R.layout.layout_custom_accident_camera;
    }
    ...
    private void dealClickListner(int id) {
        ...
        if (id == btnSystemPhoto.getId()) {//系统相册
            CameraUtil.getInstance().doOpenSystemPhoto(AccidentCameraActivity.this, new PhotoAlbum.ActivityForResultCallBack() {
                @Override
    ...
    private void setViewMode() {
        ...
        String path = getIntent().getStringExtra(CameraConstants.PHOTO_PATH);
